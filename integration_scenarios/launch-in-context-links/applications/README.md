# Adding In-Context Links to the CP4MCM Application UI
## Overview
In-Context partner-specific links can be automatically added to the CP4MCM UI pages for customer applications through a policy-based custom resource that allows for dynamic link generation with respect to each application 
## Example
### ApplicationLaunchInContextPolicy Configuration
```
...
```
### Screenshot for Bookinfo Application
![image](./app_monitoring_lic_screenshot.png)